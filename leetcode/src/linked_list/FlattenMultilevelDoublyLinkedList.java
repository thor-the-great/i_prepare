...
public class FlattenMultilevelDoublyLinkedList {
    ...
    /**
     * Do recursion. Base case - node is null. If there are no children and no next = return this node, if there is
     * next - calling recursive function with node.next.
     * If there is a child - save it, call recursive function with the child, and then re-connect nodes. node.next will
     * go to the end of the sequence, cur.next will point to func result, next.prev will be func result
     * @param head
     * @return
     */
