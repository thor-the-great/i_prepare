...
public class UniqueEmailAddresses {
    ...
    /**
     * Parse into local and domain parts, then get meaningful part of the local, add domain part at the end, put to
     * set. At the end set will have only unique emails
     * @param emails
     * @return
     */
