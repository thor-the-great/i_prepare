...
public class KeyAndRooms {
  ...
  /**
   * Interpret as graph, traverse from 0 node using DFS (stack), keep count of visit nodes.
   * Compare visited with N if match then we've visited all rooms
