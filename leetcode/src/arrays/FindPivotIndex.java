...
public class FindPivotIndex {
  /**
   * Idea - we may know if the element is a pivot. For that compute the sum of all elements first.
   * Then for every element the sum will be sum - element, and if it's a pivot then sum of
   * elements to the left == sum to the right == (sum - element)/2.
   * O(n) time, O(1) space
   * @param nums
   * @return
   */
