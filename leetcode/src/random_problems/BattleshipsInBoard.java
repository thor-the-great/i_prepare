...
public class BattleshipsInBoard {
    ...
    /**
     * Checking only fist (starting) cell of the ship by checking it's upper neighbour. If that other cell is empty
     * our cell can be counted
     * @param board
     * @return
     */
