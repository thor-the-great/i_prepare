...
public class AssignCookies {
    ...
    /**
     * Idea - sort both arrays. Start from the least child and smallest cookie see if we can feed it. If we can't -
     * increment pointer for cookies to the next biggest and do so until child is fed or we are out of elements.
     * Keep doing this until all children are fed or all cookies are used
     *
     * @param g
     * @param s
     * @return
