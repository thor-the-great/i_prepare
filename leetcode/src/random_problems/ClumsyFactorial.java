 ...
 *
 * Additionally, the division that we use is floor division such that 10 * 9 / 8 equals 11.  This guarantees the
...
public class ClumsyFactorial {
    ...
    /**
     * Idea:
     * It appears that for N >= 5 result will be N + 1 plus some tail part that depends on the last elements.
     * For N < 5 there are couple of constants.
     *
     * @param N
     * @return
     */
