...
public class CapacityToShipPackagesWithinDDays {
    ...
    /**
     * Idea - do the binary search from min to max ship capacity. Min = max of all weights, max is sum of all weights.
     *
     * Catch - count how much capacity required for every m, do the BS depends on the difference
     * @param weights
     * @param D
     * @return
     */
