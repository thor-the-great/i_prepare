...
public class MinimumNumberOfTapsToOpenWaterGarden {
    ...
    /**
     * Generate intervals first, then sort by left edge and try to merge. Choose one that to max to the right
     * If there is a gap between last right and next left - we cannot cover that part so solution is not possible
     * @param n
     * @param ranges
     * @return
     */
