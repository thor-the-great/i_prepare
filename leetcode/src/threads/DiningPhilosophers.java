 ...
 * demand are assumed.
 *
 * Design a discipline of behavior (a concurrent algorithm) such that no philosopher will starve; i.e., each can
...
public class DiningPhilosophers {
    ...
    /**
     * Use semaphores to control access to each of the forks
     * 
     * @param philosopher
     * @param pickLeftFork
     * @param pickRightFork
    ...
    public void wantsToEat(int philosopher,
        ...
        int left = (philosopher == 4) ? 0 : philosopher + 1;
